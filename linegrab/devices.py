...
class DalsaBaslerDevice(object):
    """ Use a Dalsa frame grabber and a basler camera with the 
    stdin/stdout customized example from Sapera.
    """
    def __init__(self):
        super(DalsaBaslerDevice, self).__init__()
        log.debug("DBD Startup")
