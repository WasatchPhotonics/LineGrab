...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.toolBar_GraphControls.setObjectName(_fromUtf8("toolBar_GraphControls"))
        MainWindow.addToolBar(QtCore.Qt.TopToolBarArea, self.toolBar_GraphControls)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.toolBar_GraphControls.setWindowTitle(_translate("MainWindow", "toolBar_GraphControls", None))
